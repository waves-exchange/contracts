...
describe('otc_multiasset: initializationSwapAssetsBToARejectIfWithdrawLessThanMinimum.mjs', /** @this {MochaSuiteModified} */() => {
  it('should reject initializationSwapAssetsBToA', async function () {
    ...
    const initializationSwapAssetsBToATx = invokeScript({
      ...
      payment: [{
        ...
        amount: amountAssetBLessThanMinAmountWithdraw,
      }],
      call: {
