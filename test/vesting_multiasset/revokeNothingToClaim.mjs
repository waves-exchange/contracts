 ...
 * } MochaSuiteModified
 * */
describe('vesting_multiasset: revokeNothingToClaim.mjs', /** @this {MochaSuiteModified} */() => {
  it('should return "nothing to claim" after revoke + last claim', async function () {
    ...
    await expect(api.transactions.broadcast(claim2, {})).to.be
      .rejectedWith('Error while executing account-script: vesting_multiasset.ride: nothing to claim');
  });
});
