...
describe('lp: unstakeAndGetNoLessRejectIfNoLessThenAmtAsset.mjs', /** @this {MochaSuiteModified} */() => {
  it(
    ...
    async function () {
      ...
      const noLessThenAmountAsset = 999;
      ...
      const expectedRejectMessage = `price asset amount to receive is less than ${noLessThenPriceAsset}`;
