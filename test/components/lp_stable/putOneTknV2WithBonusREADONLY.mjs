...
describe('lp_stable: putOneTknV2WithBonusREADONLY.mjs', /** @this {MochaSuiteModified} */() => {
  it('should successfully putOneTknV2WithBonusREADONLY with autoStake false', async function () {
    ...
    const expectedLpAmount = 4994065300;
    const expectedFeeAmount = 100000;
    const expectedLost = -118694;

    const expr = `putOneTknV2WithBonusREADONLY(${usdnAmount}, \"${this.usdnAssetId}\")`; /* eslint-disable-line */
