...
describe('lp_stable: fromX18WrapperREADONLY.mjs', /** @this {MochaSuiteModified} */() => {
  it(
    'should successfully fromX18WrapperREADONLY',
    async function () {
      ...
      const expr1 = `fromX18WrapperREADONLY("1234567890123456789012", 100000000)`; /* eslint-disable-line */
