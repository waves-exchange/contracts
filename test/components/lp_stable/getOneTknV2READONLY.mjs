...
describe('lp_stable: getOneTknV2READONLY.mjs', /** @this {MochaSuiteModified} */() => {
  it(
    'should successfully getOneTknV2READONLY',
    async function () {
      const usdnAmount = 1e16 / 10;
      const usdtAmount = 1e8 / 10;
      const shouldAutoStake = false;
      const lpStableAmount = 200000000 * 10e8;
      ...
      const expr = `getOneTknV2READONLY("${this.usdtAssetId}", ${lpStableAmount})`; /* eslint-disable-line */
