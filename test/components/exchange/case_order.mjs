...
describe(`${process.pid}: case order`, () => {
  before(async function () {
    const scriptPath = format({ dir: 'components/exchange/mock', base: 'case_order.ride' });
  ...
  it('should be rejected', async function () {
    ...
    return expect(broadcast(exchangeTx, apiBase)).to.be.rejectedWith('denied');
  });
});
