...
describe('voting_verified_v2: suggestAdd.mjs', /** @this {MochaSuiteModified} */ () => {
  ...
  it('should successfully suggestAdd with Waves reward', async function () {
    const expectedIndex = 0;
    const expectedIsRewardExist = true;
    const expectedRewardAssetId = 'WAVES';
    const expectedRewardAmount = 12345;
    ...
    const payments = [
      ...
      { assetId: null, amount: expectedRewardAmount },
    ];
