...
describe('referral: claimBulkExtendedTest.mjs', /** @this {MochaSuiteModified} */() => {
  it(
    ...
    async function () {
      ...
      // thirdClaimBulk, claimInternal
      // ___________________________________________________________________________________________
      const thirdClaimBulk = secondClaimBulk.stateChanges.invokes[0];
      const claimInternalAfterSecondClaimBulk = secondClaimBulk.stateChanges.invokes[1];

      expect(
        await checkStateChanges(
          thirdClaimBulk.stateChanges,
          0,
          0,
          0,
          0,
      ...
      expect(thirdClaimBulk.dApp).to.eql(address(this.accounts.referral, chainId));
      expect(thirdClaimBulk.call.function).to.eql('claimBulkInternal');
      expect(thirdClaimBulk.call.args).to.eql([
        {
          type: 'String',
          value: referrerAddress,
        }, {
      ...
      expect(thirdClaimBulk.payment).to.eql([]);

      expect(
        await checkStateChanges(
          claimInternalAfterSecondClaimBulk.stateChanges,
          6,
          1,
          0,
          0,
      ...
      expect(
        await checkStateChanges(
          withdrawReferralRewardAfterSecondClaimBulk.stateChanges,
          0,
          1,
          0,
          0,
