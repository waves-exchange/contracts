...
export const mochaHooks = {
  async beforeAll() {
    ...
    const setFeeCollectorAddressTx = data({
      additionalFee: 4e5,
      data: [{
        key: '%s__feeCollectorAddress',
        type: 'string',
        value: address(this.accounts.matcher, chainId),
      }],
      chainId,
    }, this.accounts.factoryV2);
    await api.transactions.broadcast(setFeeCollectorAddressTx, {});
    await waitForTx(setFeeCollectorAddressTx.id, { apiBase });
